...
if(isset($_POST["kirim"])) {
    ...
    if($yangcocok == 1){
		...
		$conn->query("INSERT INTO members(no_ktp, email, telepon, nama, password, tgl_lahir, bio, kelamin, status, aksi_oleh, created_at) VALUES('$iktp', '$iemail', '$itelp', '$inama', '$ipass', '$ikelahiran', 'Tidak ada biografi tertulis.', '$ikelamin', '$istatus', '$iaksi', '$idibuat')");
...
?>
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Tambah Pelanggan Baru</div>
							</div>
								...
								<div class="card-body " id="bar-parent">
                                    <form role="form" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<input required="" pattern=".{8,}" title="Mohon masukkan minimal setidaknya 8 karakter" maxlength="20" type="number" class="form-control" id="simpleFormEmail"
