...
if(isset($_POST["kirim"])) {
    ...
    if($yangcocok == 1){
        ...
        $conn->query("INSERT INTO users(no_ktp, username, nama, password, tgl_lahir, bio, kelamin, alamat, role, status, aksi_oleh, created_at) VALUES('$iktp', '$iusername', '$inama', '$ipass', '$ikelahiran', 'Tidak ada biografi tertulis.', '$ikelamin', 'Alamat tidak dimasukkan', '$iperan', '$istatus', '$iaksi', '$idibuat')");
