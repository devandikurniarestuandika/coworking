					...
					<div id="remove-scroll">
						<ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true"
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="index.php?halaman=lokasi" class="nav-link"> Lokasi </a>
									</li>
									<li class="nav-item">
										<a href="index.php?halaman=ruangan" class="nav-link"> Ruangan </a>
									</li>
									<li class="nav-item">
							...
							<li class="nav-item">
								<a href="index.php?halaman=deposit" class="nav-link nav-toggle"> <i class="material-icons">attach_money</i>
				...
				<?php
					if(isset($_GET["halaman"])){
						...
						elseif($_GET["halaman"] == "lokasi"){
							include '_lokasi/__index.php';
						}
						elseif($_GET["halaman"] == "lokasi-tambah"){
							include '_lokasi/__tambah.php';
						}
						elseif($_GET["halaman"] == "lokasi-edit"){
							include '_lokasi/__edit.php';
						}
						elseif($_GET["halaman"] == "lokasi-hapus"){
							include '_lokasi/__hapus.php';
						}
						elseif($_GET["halaman"] == "lokasi-ok"){
							include '_lokasi/__hapus-confirm.php';
						}
						//Ruangan
						elseif($_GET["halaman"] == "ruangan"){
							include '_ruangan/__index.php';
						}
						elseif($_GET["halaman"] == "ruangan-tambah"){
							include '_ruangan/__tambah.php';
						}
						elseif($_GET["halaman"] == "ruangan-edit"){
							include '_ruangan/__edit.php';
						}
						elseif($_GET["halaman"] == "ruangan-hapus"){
							include '_ruangan/__hapus.php';
						}
						elseif($_GET["halaman"] == "ruangan-ok"){
							include '_ruangan/__hapus-confirm.php';
						}
						//Produk
						...
						//Deposit
						elseif($_GET["halaman"] == "deposit"){
							include '_deposit/__index.php';
						}
						//Log Keluar
