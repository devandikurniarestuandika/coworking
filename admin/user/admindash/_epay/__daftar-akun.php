						...
						<div class="col-lg-3 col-md-6 col-sm-12 col-12">
							<div class="card">
								<div class="panel-body">
									...
									<?php
										$ambil_aktif = $conn->query("SELECT * FROM epay WHERE status LIKE 1");
						...
						<div class="col-lg-3 col-md-6 col-sm-12 col-12">
							<div class="card">
								<div class="panel-body">
									...
									<?php
										$ambil_pasif = $conn->query("SELECT * FROM epay WHERE status LIKE 0");
								...
								<div class="card-body ">
									...
									<div class="table-scrollable">
										<table class="table table-hover table-checkable order-column full-width"
											...
											<tbody>
												<?php $no=1; ?>
												<?php $ambil = $conn->query("SELECT * FROM epay LEFT JOIN members ON epay.id=members.id ORDER BY nama ASC") ?>
												...
												<tr class="odd gradeX">
													...
													<td class="center"><?= $pecah['kredit']; ?></td>
													<td class="center">
														<?php
															if ($pecah['status'] == 1) {
