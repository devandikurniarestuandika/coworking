...
<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Pemesanan Produk</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.php?halaman=beranda">Dashboard</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="index.php?halaman=pemesanan-produk">Pemesanan Produk</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Semua Pemesanan Produk</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-12 col-12">
							<div class="card">
								<div class="panel-body">
									...
									<?php
										$ambil_all = $conn->query("SELECT * FROM pemesanan");
										$total_produk = mysqli_num_rows($ambil_all);
									?>
									<div
									...
									<span class="text-small margin-top-10 full-width">
										<?php echo $total_produk; ?> Total Pemesanan</span>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12 col-12">
							<div class="card">
								<div class="panel-body">
									<h3>Pmsnan Lunas</h3>
									<?php
										$ambil_aktif = $conn->query("SELECT * FROM pemesanan WHERE status LIKE 1");
										$total_produk_aktif = mysqli_num_rows($ambil_aktif);
										$hitung_aktif = (100 * $total_produk_aktif) / $total_produk;
									?>
									<div
										class="progressbar-xs progress-rounded progress-striped progress ng-isolate-scope active">
									...
									<span class="text-small margin-top-10 full-width">
										<?php echo $total_produk_aktif; ?> Pemesanan Lunas</span>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12 col-12">
							<div class="card">
								<div class="panel-body">
									<h3>Pmsnan Batal</h3>
									<?php
										$ambil_pasif = $conn->query("SELECT * FROM pemesanan WHERE status LIKE 0");
										$total_produk_pasif = mysqli_num_rows($ambil_pasif);
										$hitung_pasif = (100 * $total_produk_pasif) / $total_produk;
									?>
									<div
										class="progressbar-xs progress-rounded progress-striped progress ng-isolate-scope active">
									...
									<span class="text-small margin-top-10 full-width">
										<?php echo $total_produk_pasif; ?> Pemesanan Batal</span>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12 col-12">
							<div class="card">
								<div class="panel-body">
									...
									<?php
										$ambil_pending = $conn->query("SELECT * FROM pemesanan WHERE status LIKE 2");
										$total_produk_pending = mysqli_num_rows($ambil_pending);
										$hitung_pending = (100 * $total_produk_pending) / $total_produk;
									?>
									<div
										class="progressbar-xs progress-rounded progress-striped progress ng-isolate-scope active">
										<div class="progress-bar progress-bar-cyan width-<?php
									...
									<span class="text-small margin-top-10 full-width">
										<?php echo $total_produk_pending; ?> Pemesanan Pending</span>
								</div>
							</div>
						</div>
					</div>
