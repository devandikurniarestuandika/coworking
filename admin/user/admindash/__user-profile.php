...
if(isset($_POST["kirim1"])) {
	$iidusr = $_SESSION['id'];
    $iktp = $_POST['ktp'];
    $iusrname = $_POST['usrname'];
	$inamel = $_POST['namel'];
	$conn->query("UPDATE users SET no_ktp='$iktp', username='$iusrname', nama='$inamel' WHERE id='$iidusr'");
								...
								<div class="card">
									...
									<div class="card-body no-padding height-9">
										<div class="profile-desc">
											Hai, perkenalkan dengan saya <?php $namafunc->Nama(); ?> senang bisa bertemu Anda.
										</div>
									...
									<div class="white-box">
										...
										<div class="tab-content">
											<div class="tab-pane active fontawesome-demo" id="tab1">
												<div id="biography">
													<p class="m-t-30">Tidak ada biografi tertulis.</p>
													<br>
												</div>
											</div>
														...
														<div class="card-body " id="bar-parent1">
															<form role="form" method="post" enctype="multipart/form-data">
																...
																<div class="form-group">
																	...
																	<input type="text" class="form-control"
																		id="simpleFormEmail" pattern=".{5,}" title="Mohon masukkan minimal setidaknya 5 karakter" readonly name="usrname" value="<?=$_SESSION['username'];?>">
																</div>
																<div class="form-group">
																...
																<div class="form-group">
																	...
																	placeholder="Isikan biografi Anda disini ..." name="bio"></textarea>
																</div>
																<div class="form-group">
