            ...
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div class="details">
                        ...
                        <h3><?php $ufunc->UserName(); //Show name who is in session user?></h3>
                        <!-- Form start-->
                        <form action="http://theme-vessel-templates.theme-vessel.ey.r.appspot.com/hotel-alpha/index.html" method="GET">
